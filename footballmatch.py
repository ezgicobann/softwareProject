...
"    border: 1px solid #8f8f8f; /* İnce kenarlık */\n"
...
"")
        ...
        self.pushButton_win.setStyleSheet("""
    QPushButton {
        border: 1px solid #8f8f8f; /* İnce kenarlık */
        border-radius: 5px; /* Yumuşak köşeler */
        background-color: #f9f9f9; /* Hafif gri arka plan */
    ...
    QPushButton:checked {
        background-color: #d1e0e0; /* Tıklanmış durumda farklı bir renk */
    }
""")
        ...
        self.pushButton_lose.setStyleSheet("""
    QPushButton {
        border: 1px solid #8f8f8f; /* İnce kenarlık */
        border-radius: 5px; /* Yumuşak köşeler */
        background-color: #f9f9f9; /* Hafif gri arka plan */
...
""")
        ...
        self.pushButton_draw.setStyleSheet("""
    QPushButton {
        border: 1px solid #8f8f8f; /* İnce kenarlık */
        border-radius: 5px; /* Yumuşak köşeler */
        background-color: #f9f9f9; /* Hafif gri arka plan */
...
""")
        ...
        self.pushButton_run_button.setStyleSheet("QPushButton {\n"
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_run_button.setText(_translate("MainWindow", "Display"))
