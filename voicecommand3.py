...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_admin_giris.setGeometry(QtCore.QRect(368, 315, 93, 28))
        self.pushButton_admin_giris.setObjectName("pushButton_admin_giris")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(230, 320, 141, 16))
        self.label_4.setObjectName("label_4")
        self.label_kelime = QtWidgets.QLabel(self.centralwidget)
        self.label_kelime.setGeometry(QtCore.QRect(373, 87, 151, 31))
