...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(390, 165, 74, 28))
        ...
        self.radioButton_kiz.setGeometry(QtCore.QRect(471, 172, 16, 16))
        self.radioButton_kiz.setText("")
        self.radioButton_kiz.setObjectName("radioButton_kiz")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setEnabled(True)
        self.label_2.setGeometry(QtCore.QRect(202, 165, 140, 28))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(20)
        sizePolicy.setVerticalStretch(0)
        ...
        self.radioButton_erkek.setGeometry(QtCore.QRect(310, 172, 44, 16))
        self.radioButton_erkek.setText("")
        self.radioButton_erkek.setObjectName("radioButton_erkek")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(200, 90, 171, 22))
        ...
        self.label_4.setGeometry(QtCore.QRect(232, 320, 141, 16))
        self.label_4.setObjectName("label_4")
        self.label_kelime = QtWidgets.QLabel(self.centralwidget)
        self.label_kelime.setGeometry(QtCore.QRect(370, 85, 151, 31))
